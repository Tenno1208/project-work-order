    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 border border-blue-100">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-black">Riwayat SPK</h2>
        ...
        <div className="flex gap-4 flex-wrap">
          <div className="flex-1 min-w-[300px] relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 border border-black/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black placeholder-black/60"
            />
          </div>
          ...
          <div className="flex gap-3">
            <div className="relative">
              ...
              <select
                ...
                className="pl-10 pr-8 py-3 border border-black/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-black appearance-none cursor-pointer"
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-5 border border-green-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-black text-sm font-medium">Total SPK</p>
              <p className="text-3xl font-bold text-black mt-1">{dummyData.length}</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-5 border border-blue-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-black text-sm font-medium">Selesai</p>
        ...
        <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-5 border border-yellow-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-black text-sm font-medium">Dalam Proses</p>
              <p className="text-3xl font-bold text-black mt-1">
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-blue-100 overflow-hidden">
        <div className="p-6 border-b border-black/20 bg-gradient-to-r from-blue-50 to-white">
          <h3 className="text-lg font-bold text-black">Daftar Riwayat SPK</h3>
              ...
              {filteredData.length === 0 ? (
                <tr>
                  <td colSpan={8} className="px-6 py-12 text-center">
                    <div className="flex flex-col items-center gap-3">
                      <Search className="text-black/40" size={48} />
                ...
                filteredData.map((item) => (
                  <tr key={item.id} className="hover:bg-blue-50 transition-colors">
                    <td className="px-6 py-4 text-sm font-semibold text-black">{item.id}</td>
                    <td className="px-6 py-4 text-sm text-black">{item.tanggalSPK}</td>
                    <td className="px-6 py-4 text-sm font-medium text-black">{item.nomorSPK}</td>
                    <td className="px-6 py-4 text-sm text-black">{item.namaPetugas}</td>
                    <td className="px-6 py-4 text-sm text-black">{item.jenisPekerjaan}</td>
                    <td className="px-6 py-4 text-sm text-black">{item.lokasi}</td>
