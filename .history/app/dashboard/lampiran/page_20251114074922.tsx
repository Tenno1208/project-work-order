...
export default function DataPengajuanPage() {
    ...
    const handleDeleteClick = (id: number, uuid: string, hal: string) => { // <--- Tambahkan 'uuid'
    if (isDeleting) return;
    // Simpan UUID, ID juga disimpan untuk referensi log/modal
    setItemToDelete({ id, uuid, hal }); // <--- Simpan UUID di state
