...
export default function DataPengajuanPage() {
    ...
    // [Perbaikan 1]: Atur status loading/creating *sebelum* navigasi
    setCreating(true); 
    ...
    // [Perbaikan 2]: Hapus setTimeout dan panggil router.push secara langsung
    router.push("/dashboard/lampiran/tambah");
    
    // [Perbaikan 3]: Langsung atur setCreating(false) atau biarkan komponen 
    // di halaman baru yang mengatur statusnya, tetapi untuk skenario ini, kita bisa reset segera.
    setCreating(false);
};
    ...
    router.push(`/dashboard/lampiran/tambah/${uuid}`);
    };
