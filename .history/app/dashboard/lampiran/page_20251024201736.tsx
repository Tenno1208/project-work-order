              ...
              <>
                ...
                <div className="mt-3">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <Upload size={16} /> Upload Foto/Dokumen
                    <input
                      type="file"
                      multiple
                        ...
                        return (
                          ...
                          >
                            {isImage ? (
                              ...
                              <div className="flex items-center justify-center h-24 text-xs bg-gray-100">
                                📄 {f.name.split(".").pop()?.toUpperCase()}
                              </div>
                            )}
                            <button
                              onClick={() => handleRemoveFile(i)}
                              className="absolute top-1 right-1 bg-black/60 text-white rounded-full px-2 opacity-0 group-hover:opacity-100 transition"
                            >
                              ✕
                            </button>
                          </div>
