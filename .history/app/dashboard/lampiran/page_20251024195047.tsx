...
const SATKERS: SatkerDef[] = [
  { id: "satker-1", label: "Satker A" },
  { id: "satker-2", label: "Satker B" },
  { id: "satker-3", label: "Satker C" },
];
...
export default function LampiranPengajuanPage() {
  ...
  useEffect(() => {
    ...
    fetch("https://gateway.pdamkotasmg.co.id/api-gw-balanced/api/auth/me", {
      ...
      .then((json: any) => {
        const name =
          json.name || json.nama || json.full_name || json.user?.name || json.data?.name || "";
            ...
            <div className="mt-3">
              <div className="grid grid-cols-12 gap-3 items-center">
                ...
                <div className="col-span-9 field-box">
                  <select name="satker" value={form.satker} onChange={handleChange} className="w-full">
