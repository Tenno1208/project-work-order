...
export async function GET(
  ...
  try {
    ...
    // 🚀 Menggunakan endpoint /detail/ untuk GET data
    const finalApiUrl = `${apiBaseUrl}/api/pengajuan/detail/${uuid}`;
    ...
    if (!res.ok) {
      ...
      // Mengirim URL eksternal lengkap ke client untuk debugging
      return NextResponse.json(
        { 
            success: false, 
