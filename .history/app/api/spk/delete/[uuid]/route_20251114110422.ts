...
const API_BASE_URL = process.env.API_BASE_URL; // Sekarang harus https://early-apes-rescue.loca.lt
...
export async function DELETE(
    ...
    // *** PERBAIKAN: External URL harus dibangun tanpa slash tambahan. ***
    // Contoh output: https://early-apes-rescue.loca.lt/api/spk/delete2e62920d-...
