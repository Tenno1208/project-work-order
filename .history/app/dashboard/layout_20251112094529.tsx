...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // Fungsi untuk menghitung rotasi jarum jam
  const getRotation = () => {
      ...
      <main className="flex-1 relative flex flex-col h-screen">
        ...
        <div className="sticky top-0 z-40 bg-gradient-to-r from-cyan-500 via-blue-600 to-blue-700 shadow-2xl relative overflow-hidden backdrop-blur-xl border-b border-white/10">
          ...
          <div className="relative z-10 px-4 lg:px-8 py-6 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            ...
            {/* CENTER - Enhanced Clock */}
            <div className="hidden lg:flex flex-col items-center">
              <div className="relative">
                {/* Analog Clock */}
                <div className="relative w-32 h-32 bg-white/20 backdrop-blur-md rounded-full shadow-xl border-2 border-white/30 overflow-hidden">
                  {/* Water Wave Background */}
                  <div className="absolute inset-0 bg-gradient-to-br from-cyan-400/30 to-blue-600/30"></div>
                  ...
                  <svg className="absolute inset-0 w-full h-full">
                    ...
                    {[...Array(12)].map((_, i) => {
                      ...
                      const x2 = 50 + (isMainHour ? 35 : 40) * Math.cos(angle * Math.PI / 180);
                      const y2 = 50 + (isMainHour ? 35 : 40) * Math.sin(angle * Math.PI / 180);
                    ...
                    <line
                      ...
                      strokeWidth="3"
                      strokeLinecap="round"
                      transform={`rotate(${getRotation().hours} 50 50)`}
                    ...
                    <line
                      ...
                      strokeWidth="2"
                      strokeLinecap="round"
                      transform={`rotate(${getRotation().minutes} 50 50)`}
                      style={{ transition: 'transform 0.5s cubic-bezier(0.4, 0.0, 0.2, 1)' }}
                    />
                    ...
                    <line
                      ...
                      strokeWidth="1"
                      strokeLinecap="round"
                      transform={`rotate(${getRotation().seconds} 50 50)`}
                      style={{ transition: 'transform 0.2s cubic-bezier(0.4, 0.0, 0.2, 1)' }}
                    />
                ...
                <div className="mt-2 bg-white/15 backdrop-blur-md px-4 py-2 rounded-xl border border-white/20 shadow-md">
                  {mounted && (
                    <p className="text-white text-lg font-bold tracking-wider drop-shadow-lg text-center">
                ...
                {/* Date Display */}
                {mounted && (
                  <p className="text-cyan-100 text-xs font-medium mt-2 text-center">
