...
// Custom Notification Component (mengganti alert)
...
// Custom Confirmation Modal (mengganti window.confirm)
...
export default function LampiranPengajuanPage() {
    ...
    // 🔹 State untuk Notifikasi dan Modal Kustom (PENGGANTI alert/confirm)
    ...
    // useEffects for fetching data (no changes needed)
    useEffect(() => {
    ...
    // Fungsi untuk membuat gambar transparan (untuk tanda tangan)
        ...
        return new Promise((resolve) => {
            ...
            img.onload = () => {
                ...
                for (let i = 0; i < data.length; i += 4) {
                    ...
                    // Membuat warna putih atau warna sangat gelap menjadi transparan
    ...
    // 🛠️ FUNGSI BARU: Logika Panggilan API
    const proceedSubmission = useCallback(async () => {
        ...
        try {
            ...
            // 2. Siapkan FormData untuk dikirim ke /api/pengajuan
            ...
            // Tambahkan file tanda tangan
            if (ttdPelaporFile) {
                formDataToSend.append('ttdPelapor', ttdPelaporFile);
            }
            
            // 3. Panggil API internal
            const res = await fetch("/api/pengajuan", {
                method: "POST",
                headers: {
                    "Authorization": `Bearer ${token}`, 
                },
                body: formDataToSend, // Kirim FormData yang sudah ada file mentah
            });
            ...
            if (result.success) {
                ...
                // router.push('/dashboard/riwayat'); // Arahkan ke halaman riwayat jika perlu
            } else {
    ...
    // 🛠️ FUNGSI handleAjukan: Menangani Validasi dan Konfirmasi
    const handleAjukan = async () => {
        ...
        // Jika semua validasi dan konfirmasi opsional OK, langsung ajukan
                ...
                <div id="print-area" className="p-6">
                    ...
                    <div className="mt-20 flex justify-center text-center gap-60">
                        ...
                        <div>
                            ...
                            {/* Kontrol Zoom/Drag hanya terlihat di input mode */}
                            {ttdPelaporPreview && !isPrintMode && (
