...
// --- DEFINISI VARIABEL LINGKUNGAN (Diambil dari .env) ---

// API Utama Pengajuan (GET & POST diambil dari variabel ENV spesifik)
...
// URL File Handler PDAM yang stabil (TIDAK BERUBAH)
...
        // 1. Upload TTD jika ada (Menggunakan FILE_HANDLER_URL PDAM)
...
        // 2. Upload Lampiran (max 4 files) (Menggunakan FILE_HANDLER_URL PDAM)
        let fileIndex = 0;
        while (fileIndex < 4) { 
...
        // 4. Kirim data ke API eksternal (Menggunakan POST_API_PENGAJUAN_URL dari ENV)
