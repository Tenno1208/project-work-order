...
return (
<div
    className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-100 p-4 relative overflow-hidden">
    ...
    <div className="absolute bottom-10 right-10 w-40 h-40 bg-blue-300 rounded-full opacity-20 blur-3xl animate-pulse">
    </div>
                ...
                <div className="mb-5">
                    ...
                    <div className="relative">
                        ...
                        <input type="text"
                            ...
                            placeholder="Masukkan NPP Anda" value={npp} onChange={(e)=> setNpp(e.target.value)}
                        />
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="relative">
                        ...
                        <input type={showPassword ? "text" : "password" }
                            ...
                            placeholder="Masukkan password" value={password} onChange={(e)=>
