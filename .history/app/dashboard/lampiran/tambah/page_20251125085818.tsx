...
// Note: Komponen ini diasumsikan ada di file Anda
        ...
        if (res.ok) {
            ...
            if (uniqueTtdPaths.length > 0) {
                ...
                if (serverTtdPath) {
                    ...
                    const primaryTtdUrl = processedUrls.find(url => url.includes(serverTtdPath.slice(-10))) || processedUrls[0];
