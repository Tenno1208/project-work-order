...
import { Droplets, IdCard, Lock, Eye, EyeOff, Loader2, Zap } from "lucide-react";
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-slate-800/40 backdrop-blur-2xl rounded-3xl shadow-2xl overflow-hidden border border-blue-500/20 relative">
          ...
          <div className="relative p-8 text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl mb-4 shadow-lg shadow-blue-500/50 relative overflow-hidden group">
              <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
              <Droplets className="w-10 h-10 text-white relative z-10" />
            </div>
            
            <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-400 bg-clip-text text-transparent mb-2 tracking-tight">
              PDAM Portal
            </h1>
            <p className="text-blue-300/80 text-sm flex items-center justify-center gap-2">
          ...
          <form onSubmit={handleLogin} className="p-8 pt-4 relative z-10">
            ...
            <div className="mb-6 group">
              ...
              <div className="relative">
                ...
                <IdCard className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors duration-300 ${focusedInput === 'npp' ? 'text-blue-400' : 'text-slate-500'}`} />
                <input
                  type="text"
            ...
            <div className="mb-8 group">
              ...
              <div className="relative">
                ...
                <Lock className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors duration-300 ${focusedInput === 'password' ? 'text-blue-400' : 'text-slate-500'}`} />
                <input
                  type={showPassword ? "text" : "password"}
                  className="w-full pl-12 pr-12 py-3.5 bg-slate-700/50 border border-slate-600/50 rounded-xl focus:border-blue-500/50 focus:bg-slate-700/70 outline-none transition-all text-white placeholder-slate-400 relative z-10 backdrop-blur-sm"
          ...
          {/* Footer */}
          <div className="text-center pb-8 px-8 relative z-10">
