...
const navigateTo = (href: string) => {
  console.log(`[NAVIGASI] Menuju ke: ${href}`);
                ...
                <tbody className="divide-y divide-gray-100">
                  {filteredSpk.map((spk, index) => (
                    <tr
                      ...
                      onClick={() => navigateTo("/app/dashboard/spk/format")}
                    >
                      <td className="px-4 py-3 text-black">{index + 1}</td>
                      <td className="px-4 py-3 font-semibold text-blue-700 group-hover:text-blue-800 whitespace-nowrap">
                        {spk.nomor}
                      </td>
                      ...
                      <td className="px-4 py-3 text-center">
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            navigateTo("/app/dashboard/spk/format");
                          }}
