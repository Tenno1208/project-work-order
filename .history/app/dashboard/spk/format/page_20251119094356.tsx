                  ...
                  <div className="flex flex-wrap items-center p-1 border border-gray-500 rounded-md bg-white min-h-[40px] focus-within:ring-2 focus-within:ring-blue-300">
                    ...
                    <AutoCompletePerson
                      ...
                      onSelect={(name) => {
                        ...
                        // slight delay to ensure state updated? Not needed, handleAddPerson reads currentPersonInput,
                        // but to be safe, call directly after setting (works because getPersonDetail relies on pegawaiList)
                        // We can call handleAddPerson directly using name by temporarily setting currentPersonInput then adding:
