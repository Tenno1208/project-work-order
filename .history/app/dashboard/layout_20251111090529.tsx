    ...
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      ...
      >
        ...
        <motion.div
          ...
          className="px-6 py-8.7 border-b border-blue-100/60 bg-gradient-to-br from-blue-600 via-blue-600 to-blue-700 shadow-inner relative"
        >
          ...
          <motion.button
            ...
            className="absolute top-1/2 right-3 -translate-y-1/2 bg-white/25 hover:bg-white/40 text-white rounded-full shadow-lg w-8 h-8 flex items-center justify-center transition-all duration-300 border border-white/30 backdrop-blur-md"
          >
