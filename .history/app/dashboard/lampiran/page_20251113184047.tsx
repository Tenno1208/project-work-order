...
// --- KONSTANTA API (Diusahakan menggunakan path proxy internal jika memungkinkan) ---
const LIST_API_PATH = "/api/pengajuan"; 
// Ganti DELETE_API_BASE ke proxy jika tersedia. Jika tidak, pertahankan URL lengkap, 
// namun berhati-hatilah dengan masalah CORS/localtunnel.
