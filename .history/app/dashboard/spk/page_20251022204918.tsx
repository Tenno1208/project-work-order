...
export default function SPKPage() {
  ...
  <div className="fixed inset-0 bg-black/70 flex justify-center items-center z-50">
    <div className="bg-white p-8 rounded-xl shadow-2xl w-[800px] h-[1100px] overflow-y-auto relative text-black">
      <div id="printArea" className="text-sm leading-relaxed">
