    ...
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50 to-blue-50 relative overflow-hidden">
      ...
      <main className="flex-1 relative flex flex-col h-screen">
        ...
        <div className="sticky top-0 z-40 bg-gradient-to-r from-cyan-500 via-blue-600 to-blue-700 shadow-2xl relative overflow-hidden backdrop-blur-xl border-b border-white/10">
          ...
          <div className="relative z-10 px-4 lg:px-6 py-6 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            {/* LEFT - Page Info */}
            ...
            <div className="hidden lg:flex items-center gap-4">
              <div className="relative group">
                {/* Water Drop Icon */}
                <div className="absolute -left-10 top-1/2 -translate-y-1/2 opacity-60 group-hover:opacity-100 transition-opacity">
                  <Droplet className="text-white/80" size={20} />
                </div>
                
                {/* Clock Container */}
                <div className="bg-white/15 backdrop-blur-md rounded-2xl px-6 py-3 border border-white/20 shadow-xl relative overflow-hidden group-hover:bg-white/20 transition-all">
                  ...
                  <div className="relative z-10 flex items-center gap-3">
                    {mounted && (
                      <>
                        {/* Icon Clock */}
                        <Clock className="text-white/90 drop-shadow-sm" size={20} strokeWidth={2.5} />
                        ...
                        <div className="flex items-baseline gap-1">
                          ...
                          <span className="text-cyan-200 text-lg font-medium animate-pulse">
                            {currentTime.toLocaleTimeString("id-ID", {
                              second: "2-digit",
                            })}
                          </span>
                ...
                {/* Wave Icon */}
                <div className="absolute -right-10 top-1/2 -translate-y-1/2 opacity-60 group-hover:opacity-100 transition-opacity">
                  <Waves className="text-white/80" size={20} />
                </div>
              </div>
            </div>
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50 to-blue-50 relative overflow-hidden text-sm">
      ...
      <main className="flex-1 relative flex flex-col h-screen">
            ...
            <div className="hidden lg:flex items-center gap-3"> {/* Reduced gap */}
              <div className="relative group">
                ...
                <div className="absolute -right-8 top-1/2 -translate-y-1/2 opacity-60 group-hover:opacity-100 transition-opacity">
                  <Waves className="text-white/80" size={16} /> {/* Reduced size 20 -> 16 */}
                </div>
              </div>
            </div>

            {/* RIGHT - User & Notification */}
            <div className="flex items-center gap-3 lg:gap-4"> {/* Reduced gap */}
              {/* User Info */}
              <div className="flex items-center bg-white/20 rounded-xl border border-white/30 p-1.5 lg:p-2 pr-3 lg:pr-4 shadow-lg backdrop-blur-md hover:bg-white/25 transition-all"> {/* Reduced padding/rounded/shadow */}
                ...
                <div className="ml-2 lg:ml-2 text-left">
                  {loading ? (
                    ...
                    <>
                      <p className="text-white text-xs font-bold leading-tight drop-shadow"> {/* Reduced size sm -> xs */}
                        {userData?.nama}
                      </p>
                      <p className="text-cyan-100 text-xs leading-tight">NPP: {userData?.npp}</p>
                    </>
                ...
                <button className="ml-2 lg:ml-3 p-1.5 hover:bg-white/20 rounded-md transition-colors hidden lg:block">
                  <Settings className="text-white" size={16} /> {/* Reduced size 18 -> 16 */}
                </button>
              </div>
              ...
              <button className="bg-white/20 backdrop-blur-sm p-2 rounded-lg hover:bg-white/30 transition-all duration-300 border border-white/30 shadow-lg relative group"> {/* Reduced padding/rounded/shadow */}
                <Bell className="text-white group-hover:scale-110 transition-transform" size={18} /> {/* Reduced size 20 -> 18 */}
        ...
        {/* CONTENT AREA */}
        <div className="flex-1 overflow-auto p-4 lg:p-6"> {/* Reduced padding */}
          <div className="max-w-7xl mx-auto">
            {children}
