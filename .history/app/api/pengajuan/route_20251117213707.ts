...
        let ttdUrl: string | undefined = undefined; // Diinisialisasi
...
        // #################################################
        // Ganti LOGIKA UPLOAD LAMPIRAN LAMA (file0) dengan loop yang baru:
...
        
        // #################################################
        // 3. PERBAIKAN PENGIRIMAN file_paths (Wajib Ada + Format Array)
        // #################################################
...
        // #################################################
        if (ttdUrl) {
            externalFormData.append('ttd_pelapor', ttdUrl); // Menggunakan ttd_pelapor sesuai error sebelumnya
        } else {
             // Kirim nilai kosong jika TTD wajib diisi tapi tidak ada file baru/url baru
