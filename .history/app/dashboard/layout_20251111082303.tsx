          ...
          <div className="relative z-10 px-8 py-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                {/* User Info */}
                <div className="bg-white/20 backdrop-blur-sm rounded-xl border border-white/30 shadow-lg p-2 flex items-center gap-3">
                  ...
                  <div className="pr-3 border-r border-white/30">
                    ...
                    <p className="text-blue-100 text-xs leading-tight">admin@pdam.id</p>
                  </div>
