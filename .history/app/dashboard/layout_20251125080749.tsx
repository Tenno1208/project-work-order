...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    const fetchAndStorePermissions = async (token: string) => {
        try {
            ...
            if (!res.ok) {
                ...
                // Jika API gagal, simpan array kosong agar caching berhenti
            ...
            // Logika parsing yang ketat: memastikan array diambil dari field 'data'
            ...
            // Jika ada error, tetap simpan array kosong agar loadInitialData tidak fetch terus
            localStorage.setItem("user_permissions", JSON.stringify([])); 
            return [];
        }
    };
    ...
    useEffect(() => {
        ...
        const loadInitialData = async () => {
            ...
            // **PERUBAHAN PENTING:** Hanya parse jika string ada dan tidak kosong
            ...
            // Catatan: Jika permissionsData adalah array kosong, itu akan dievaluasi true,
            // sehingga jika data ada tapi kosong, API tidak dipanggil.
            // Kita harus cek eksplisit permissionsData.length === 0 jika permissionsData bukan null
