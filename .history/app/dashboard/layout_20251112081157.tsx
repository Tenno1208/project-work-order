  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50 to-blue-50 relative overflow-hidden">
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-cyan-400 via-blue-500 to-cyan-400 animate-pulse"></div>
        ...
        <div className="px-6 py-8 border-b border-cyan-100/60 bg-gradient-to-br from-cyan-500 via-blue-600 to-blue-700 relative overflow-hidden">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute bottom-6 left-16 w-1 h-1 bg-white/20 rounded-full animate-ping animation-delay-2000"></div>
          </div>
          ...
          <div className={`flex items-center ${collapsed ? "justify-center" : "gap-4"} relative z-10`}>
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-white/40 to-white/10 p-3.5 rounded-2xl shadow-2xl backdrop-blur-md border border-white/30">
                ...
                >
                  ...
                  {item.subItems && !collapsed && (
                    <button
                      ...
                      className="ml-auto p-2 hover:bg-white/20 rounded-lg transition-colors relative z-10"
                    >
                      <ChevronRight
                        size={16}
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-[60] bg-white/90 backdrop-blur-md p-3 rounded-xl shadow-lg border border-cyan-200"
      >
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-50 bg-black/50 backdrop-blur-sm" onClick={() => setMobileMenuOpen(false)}>
          <div className="w-80 h-full bg-white shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="px-6 py-8 border-b border-cyan-100 bg-gradient-to-br from-cyan-500 via-blue-600 to-blue-700">
              <div className="flex items-center gap-4">
                <div className="bg-white/40 p-3.5 rounded-2xl">
                  <Droplet className="text-white" size={32} />
                </div>
                <div className="text-white">
                  <h1 className="font-bold text-3xl">PDAM</h1>
                  <p className="text-cyan-100 text-sm">Work Order System</p>
                </div>
              </div>
            </div>
            <nav className="p-4 space-y-2">
              {menuItems.map((item) => {
                ...
                return (
                  <button
                    key={item.href}
                    className="flex items-center gap-4 px-5 py-4 rounded-2xl w-full text-left hover:bg-cyan-50"
                  >
                    <Icon size={22} />
      ...
      {showLogoutConfirm && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[9999] backdrop-blur-sm">
          <div className="bg-white rounded-3xl shadow-2xl p-8 w-[90%] max-w-sm text-center relative overflow-hidden">
      ...
      <main className="flex-1 relative flex flex-col h-screen">
        ...
        <div className="sticky top-0 z-40 bg-gradient-to-r from-cyan-500 via-blue-600 to-blue-700 shadow-2xl relative overflow-hidden backdrop-blur-xl border-b border-white/10">
          ...
          <div className="absolute inset-0 opacity-20">
            ...
            <div className="absolute bottom-0 right-0 w-72 h-72 bg-cyan-300 rounded-full blur-3xl animate-pulse animation-delay-2000"></div>
          </div>

          {/* Wave Pattern */}
          <svg className="absolute bottom-0 left-0 w-full opacity-10" viewBox="0 0 1440 100" preserveAspectRatio="none">
            <path
              fill="white"
          ...
          <div className="relative z-10 px-4 lg:px-8 py-6 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            ...
            {/* CENTER - Clock */}
            <div className="hidden lg:flex flex-col items-center bg-white/15 px-8 py-3 rounded-2xl border border-white/20 shadow-xl backdrop-blur-md">
            ...
            <div className="flex items-center gap-3 lg:gap-6">
              {/* User Info */}
              <div className="flex items-center bg-white/20 rounded-2xl border border-white/30 p-2 lg:p-3 pr-3 lg:pr-5 shadow-xl backdrop-blur-md">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {[
                ...
                <div
                  key={idx}
                  className="bg-white/90 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-cyan-100/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1"
                >
            ...
            <div className="bg-gradient-to-br from-cyan-500 via-blue-600 to-blue-700 rounded-3xl p-8 shadow-2xl text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-3xl font-bold mb-3">Selamat Datang di PDAM Work Order System</h2>
                <p className="text-cyan-100 text-lg mb-6">
                  Kelola semua pekerjaan dan pengajuan dengan mudah dan efisien
                </p>
                <button className="bg-white text-blue-600 px-6 py-3 rounded-xl font-semibold hover:bg-cyan-50 transition-all shadow-lg hover:shadow-xl">
                  Mulai Sekarang
                </button>
              </div>
            </div>
