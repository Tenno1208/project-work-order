              ...
              >
                <div className="flex mt-3 items-center">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateField("tanggalSelesai", e.target.value)
                    }
                    className="border border-gray-400 rounded-md bg-white outline-none px-2 py-1 text-sm w-[160px] focus:ring focus:ring-blue-300"
                  />
                </div>
