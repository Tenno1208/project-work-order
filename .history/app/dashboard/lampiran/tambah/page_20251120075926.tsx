...
        // Jika ada API untuk fetch data ini, panggil di useEffect
    ]);
        ...
        <div className="p-6 min-h-screen">
            ...
            <div className="max-w-[900px] mx-auto bg-white border border-gray-300 shadow-md rounded-lg text-gray-800">
                ...
                <div id="print-area" className="p-6">
                    ...
                        <div className="col-span-3 font-semibold">Ref. Surat :</div>
                        <div className="col-span-9">
                            {isPrintMode ? (
                                <span className="font-normal">{form.referensiSurat || "-"}</span>
                            ) : (
                                <input
                                    type="text"
                                    name="referensiSurat"
                    ...
                                    placeholder="Isi nomor surat referensi (Opsional)"
                                    className="w-full p-1 border border-gray-300 rounded text-sm" // Dibuat kecil (text-sm)
                                />
                            )}
