...
// --- KONSTANTA API BARU ---
// Anggap ini adalah endpoint yang sama dengan yang digunakan di backend Anda
const SUBMIT_API_PATH = "/api/pengajuan"; 
const DETAIL_API_PATH = "https://brave-chefs-refuse.loca.lt/api/pengajuan/detail";
const UPDATE_API_PATH = "https://brave-chefs-refuse.loca.lt/api/pengajuan/update"; 
const MAX_RETRIES = 3; 
...
export default function LampiranPengajuanPage() {
    ...
    const handleRemoveFile = (index: number) => {
        ...
        // Note: Untuk file yang sudah ada (existingFilePaths), penghapusan ini 
        // hanya bersifat visual. Untuk menghapus di server, Anda perlu 
        // mengirim daftar file yang tersisa/dihapus pada saat submit.
        // Asumsi server Anda menangani file lama dengan membandingkan daftar.
