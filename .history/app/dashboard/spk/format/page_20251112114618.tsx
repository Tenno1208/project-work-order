...
useEffect(() => {
  // Ambil data jenis pekerjaan dari API
  fetch("https://zephyrean-cycloidally-triston.ngrok-free.dev/api/master-jenis-pekerjaan")
    .then((res) => res.json())
    .then((data) => {
    ...
    .catch((err) => console.error("Gagal ambil jenis pekerjaan:", err));
}, []);
