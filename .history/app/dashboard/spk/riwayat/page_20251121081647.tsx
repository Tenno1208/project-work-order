    ...
    {loading ? (
        ...
        <div className="py-12 text-center bg-red-50/50">
            ...
            <p className="text-red-700 text-sm font-medium">
                {/* Tampilkan pesan Error dari API / 404 */}
        ...
        // --- KONDISI 3: SUKSES, TAPI ARRAY DATA UTAMA KOSONG ---
        <div className="py-12 text-center">
            <History className="mx-auto text-black/40 mb-3" size={32} />
            <p className="text-black text-sm font-medium">
                Anda belum memiliki riwayat pengajuan.
            </p>
            <p className="text-xs text-black/60 mt-1">
                Silakan buat pengajuan SPK baru untuk melihat riwayat di sini.
            </p>
        </div>
    ) : (
                    <>
                            ...
                            <table className="min-w-full">
                                ...
                                <tbody className="divide-y divide-black/10">
                                    {filteredData.length === 0 ? (
                                        // --- KONDISI 4.1: Data Kosong Karena Search/Filter ---
                                        <tr>
