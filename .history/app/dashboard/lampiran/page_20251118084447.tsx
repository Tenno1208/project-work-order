...
                }));
   ...
   // Di dalam DataPengajuanPage
const handleBuatPengajuan = () => {
    setCreating(true); 
    
    // Pastikan tidak ada kode yang tersisa dari generateNoSurat atau localStorage
    // Kecuali jika Anda ingin membersihkan nilai lama, 
    // tetapi membersihkannya di sini tidak diperlukan karena Anda ingin menghapus logikanya.

    // OPSIONAL: Bersihkan nilai lama jika memang pernah ada.
    // localStorage.removeItem("nomor_surat_terakhir"); 
