...
export default function LampiranPengajuanPage() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      router.push("/"); // balik ke login kalau belum login
      return;
    }
    ...
    fetch("/api/me", {
      ...
      .then((data) => {
        if (data?.nama && data?.npp) {
          ...
          console.warn("Data user kosong:", data);
        }
      })
    ...
    <div className="p-6">
      <style>{`
        ...
        @media print {
          ...
          /* Dalam mode cetak, hilangkan semua border input/select */
      ...
      <div className="max-w-[900px] mx-auto bg-white border border-gray-300 shadow-md rounded-lg text-gray-800">
        ...
        <div id="print-area" className="p-6">
          ...
          <div className="mt-20 flex justify-center text-center gap-65">
            <div>
            ...
            <div>
              ...
              <div className="mt-16 text-sm"> {form.pelapor || "(...........................)"}</div>
              <div className="text-xs mt-1">
