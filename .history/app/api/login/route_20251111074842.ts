...
export async function POST(req: Request) {
  ...
  try {
    ...
    // ❌ Jika gagal login, tangkap pesan error dari API PDAM
    // Beberapa API bisa punya struktur error berbeda (data.message, data.error, dll)
    // Kita coba beberapa kemungkinan untuk lebih fleksibel.
