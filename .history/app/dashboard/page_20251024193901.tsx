    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-3xl shadow-lg p-8 mb-6 border border-blue-100">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-blue-600">Dashboard PDAM Work Order System</p>
          </div>
          <div className="flex gap-3">
            <button className="p-4 bg-blue-50 hover:bg-blue-100 rounded-2xl transition-all duration-200 border border-blue-200 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          { title: "Completed", value: "206", icon: LayoutDashboard, color: "purple" },
        ].map((stat, idx) => (
          <div
            key={idx}
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className={`p-4 bg-gradient-to-br from-${stat.color}-500 to-${stat.color}-600 rounded-2xl shadow-lg`}>
