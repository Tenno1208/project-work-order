...
{!isPrintMode && (
  <div className="mt-3 text-center">
    ...
    {ttdPelaporPreview && (
      <div className="border border-gray-300 rounded inline-block relative w-[180px] h-[100px] bg-gray-50 shadow-sm">
        <Draggable bounds="parent" nodeRef={nodeRef}>
          <img
            ...
            className="cursor-move absolute top-1/2 left-1/2 
                       -translate-x-1/2 -translate-y-1/2
                       max-h-[80px] max-w-[160px] object-contain"
          />
        </Draggable>
      </div>
    )}
    ...
    {ttdPelaporPreview && (
      <>
        ...
        <div className="text-xs mt-1 text-gray-600 select-none">
          Ukuran preview:{" "}
          {Math.round(160 * ttdScale)}px × {Math.round(80 * ttdScale)}px
        </div>
      </>
    )}
  </div>
