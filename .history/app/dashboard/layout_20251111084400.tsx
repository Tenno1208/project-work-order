    ...
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      ...
      >
        ...
        <motion.div
          ...
          className="px-8 py-10 border-b border-blue-100/60 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 shadow-inner relative"
        >
        ...
        <motion.button
          ...
          className="absolute top-10 -right-4 bg-gradient-to-br from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-full shadow-xl w-9 h-9 flex items-center justify-center transition-all duration-300 border-4 border-white"
        >
      ...
      <main className="flex-1 relative flex flex-col h-screen">
        <div className="sticky top-0 z-50 bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 shadow-lg relative overflow-hidden">
