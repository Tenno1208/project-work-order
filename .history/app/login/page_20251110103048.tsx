...
export default function LoginPage() {
  ...
  try {
    const hwid = navigator.userAgent; // atau nilai tetap seperti "web-client"

    const response = await fetch("https://gateway.pdamkotasmg.co.id/api-gw-balanced/api/auth/login", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ npp, password, hwid }), // ✅ kirim 3 field
    });
