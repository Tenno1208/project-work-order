...
{!isPrintMode && (
  <button
    onClick={() => {
      // Logic submit bisa diisi di sini
      console.log("Form diajukan:", form, files, ttdPelaporFile);
      alert("Pengajuan berhasil diajukan!");
    }}
    className="fixed bottom-4 right-4 bg-green-600 text-white px-4 py-2 rounded shadow-lg hover:bg-green-700 transition"
  >
    Ajukan
  </button>
)}
