...
import { Bell, Settings, ClipboardList, FileText, LayoutDashboard, CircleCheckBig, AirVent } from "lucide-react";
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          { title: "Completed", value: "206", icon: AirVent, color: "purple" },
        ].map((stat, idx) => (
          <div
            key={idx} 
