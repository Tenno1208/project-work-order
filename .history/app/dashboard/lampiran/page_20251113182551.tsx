            ...
            {isDeleting && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black bg-opacity-60">
                    <div className="bg-white p-6 rounded-xl shadow-2xl flex items-center">
                        ...
                        <span className="text-lg font-semibold text-gray-800">Menghapus data ID {itemToDelete}...</span>
                    </div>
                </div>
            )}
                                ...
                                >
                                    ...
                                    <td className="py-3 px-4 text-center whitespace-nowrap">
                                        <div className="flex justify-center space-x-2">
                                            ...
                                            {/* Action: EDIT (Ubah Data) - Menggunakan UUID untuk Navigasi */}
                                            <button
                                            ...
                                            {/* Action: DELETE (Hapus Data) - Membuka Modal Konfirmasi */}
                                            <button
