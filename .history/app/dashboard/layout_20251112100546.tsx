...
<div
  ...
  } border-b border-cyan-100/60 bg-gradient-to-br from-cyan-500 via-blue-600 to-blue-700 relative overflow-hidden transition-all duration-300`}
  style={{
    width: collapsed ? "80px" : "100%",
    minWidth: collapsed ? "80px" : "auto",
  }}
>
