      ...
      <main className="flex-1 relative flex flex-col h-screen">
        ...
        <div className="sticky top-0 z-40 bg-gradient-to-r from-cyan-500 via-blue-600 to-blue-700 shadow-2xl relative overflow-hidden backdrop-blur-xl border-b border-white/10">
          ...
          <div className="relative z-10 px-4 lg:px-6 py-6 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            ...
            {/* FLOATING CLOCK ICON DI TENGAH HEADER */}
<div className="hidden lg:block absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30">
  <div className="relative group">
    <div className="bg-gradient-to-br from-cyan-400 to-blue-600 p-4 rounded-full shadow-2xl border border-white/30 hover:scale-110 transition-transform duration-500 backdrop-blur-md">
      <Clock className="text-white drop-shadow-lg animate-pulse" size={30} strokeWidth={2.5} />
    </div>
