...
export default function DaftarSPKPage() {
    ...
    const spkUuid = modal.spkToDelete.uuid; // Ambil UUID
    closeModal();
    setLoading(true);
    ...
    try {
        // *** PERUBAHAN KRUSIAL: Panggil API Route lokal dengan UUID ***
        // Route lokal: /api/spk/delete/[uuid]
        ...
        // Hapus dari state berdasarkan ID (karena key array adalah ID)
