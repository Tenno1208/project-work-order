...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        ...
        // --- DEFENISI FUNGSI FETCH PERMISSIONS (LOKAL) ---
        const fetchUserPermissions = async (token: string) => {
            try {
                ...
                // Asumsi API mengembalikan array string permissions di field 'data'
                ...
                console.log("✅ User Permissions loaded and stored in localStorage.");

            } catch (err) {
                console.error("Error fetching permissions:", err);
            }
        };
        // --- AKHIR DEFENISI FUNGSI FETCH PERMISSIONS ---
        ...
        const fetchUserData = async () => {
            try {
                ...
                // 2. PANGGIL FETCH PERMISSIONS SETELAH USER DATA BERHASIL
                await fetchUserPermissions(token); // <-- PANGGILAN KRITIS
