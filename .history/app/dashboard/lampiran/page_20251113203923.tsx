...
// FIX: Variabel lingkungan yang diakses di client-side (browser) HARUS diawali NEXT_PUBLIC_.
// Mengganti DELETE_API_PENGAJUAN_URL dengan NEXT_PUBLIC_DELETE_API_PENGAJUAN_URL
const DELETE_API_BASE = process.env.NEXT_PUBLIC_DELETE_API_PENGAJUAN_URL || "http://default-delete-pengajuan-api-gagal-dimuat.com";
const MAX_RETRIES = 3; 
...
        setTimeout(() => {
            setCreating(false);
            router.push("/dashboard/lampiran/tambah/page.tsx"); // Pastikan ini sesuai path Next.js Anda
        }, 500);
    };
