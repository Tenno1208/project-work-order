...
export default function SPKPage() {
  ...
  const EditableLine = ({ value, placeholder, onChange }: any) => (
    <div
      ...
      className="inline-block border-b border-black pb-0.5 min-w-[120px] text-black"
      style={{ outline: "none", minHeight: 18, backgroundColor: "transparent" }}
    >
      {value || placeholder || " "}
    </div>
  );
  ...
  const EditableBox = ({ value, onChange }: any) => (
    <div
      ...
      className="min-h-[140px] p-2 text-black"
      style={{ outline: "none", whiteSpace: "pre-wrap", backgroundColor: "transparent" }}
    >
      {value || " "}
    </div>
  );
  ...
  return (
    <div className="p-6 min-h-screen bg-gray-100">
      <div className="max-w-4xl mx-auto">
        ...
        <div
          ref={docRef}
          className="bg-gray-50 p-8 text-[13px] leading-relaxed font-serif shadow-md rounded-xl"
