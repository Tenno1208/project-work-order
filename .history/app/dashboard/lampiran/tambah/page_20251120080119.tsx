...
                            {/* SISIPAN: REF SURAT (DROPDOWN KECIL) */}
                            <div className="mt-3">
...
                                ) : (
                                    <div className="select-input-only mt-1">
                                        <Select
                                            name="referensiSurat"
...
                                            }
                                            options={refSuratOptions.map((s) => ({ value: s, label: s }))}
                                            placeholder="Pilih referensi (Opsional)"
                                            className="text-xs w-full" // Lebih kecil
                                            isClearable={true}
                                            styles={{
