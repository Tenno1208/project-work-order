  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden opacity-30">
        <div className="absolute top-20 left-20 w-96 h-96 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{animationDuration: '7s'}}></div>
        <div className="absolute top-40 right-20 w-96 h-96 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{animationDuration: '9s', animationDelay: '2s'}}></div>
        <div className="absolute -bottom-20 left-40 w-96 h-96 bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{animationDuration: '11s', animationDelay: '4s'}}></div>
      </div>
      ...
      >
        ...
        <div className="px-6 py-8 border-b border-cyan-100/60 bg-gradient-to-br from-cyan-500 via-blue-600 to-blue-700 relative overflow-hidden">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute top-8 right-12 w-1.5 h-1.5 bg-white/40 rounded-full animate-ping" style={{animationDelay: '1s'}}></div>
            <div className="absolute bottom-6 left-16 w-1 h-1 bg-white/20 rounded-full animate-ping" style={{animationDelay: '2s'}}></div>
          </div>
                  ...
                  <div className="ml-8 mt-2 space-y-1 transition-all duration-300">
                    {item.subItems.map((subItem) => {
                      ...
                      return (
                        <button
                          key={subItem.href}
                          className={`group flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 w-full hover:scale-105 ${
                            subActive
          ...
          <div className="w-80 h-full bg-white shadow-2xl transform transition-transform" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="px-6 py-8 border-b border-cyan-100 bg-gradient-to-br from-cyan-500 via-blue-600 to-blue-700 relative overflow-hidden">
              <div className="absolute inset-0 opacity-20">
                <div className="absolute top-4 left-8 w-2 h-2 bg-white/30 rounded-full animate-ping"></div>
                <div className="absolute bottom-6 right-12 w-1.5 h-1.5 bg-white/40 rounded-full animate-ping" style={{animationDelay: '1s'}}></div>
              </div>
      ...
      <main className="flex-1 relative flex flex-col h-screen">
        ...
        <div className="sticky top-0 z-40 bg-gradient-to-r from-cyan-500 via-blue-600 to-blue-700 shadow-2xl relative overflow-hidden backdrop-blur-xl border-b border-white/10">
          ...
          <div className="absolute inset-0 opacity-20">
            ...
            <div className="absolute bottom-0 right-0 w-72 h-72 bg-cyan-300 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
          </div>
        ...
        <div className="flex-1 overflow-auto p-4 lg:p-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-cyan-500 via-blue-600 to-blue-700 rounded-3xl p-8 shadow-2xl text-white relative overflow-hidden">
              <div className="absolute inset-0 opacity-20">
                <Waves className="absolute top-4 right-8 w-32 h-32 animate-pulse" />
                <Droplet className="absolute bottom-8 left-12 w-24 h-24 animate-pulse" style={{animationDelay: '1s'}} />
              </div>
