  ...
  return (
    <div className="space-y-6 text-black">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">Data Pengajuan</h2>
        <button
      ...
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="pl-10 pr-4 py-2 w-full border border-black/30 text-black rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
        />
      </div>

      <div className="bg-white border border-black/20 rounded-xl shadow-sm overflow-hidden">
            ...
            {loading ? (
              <tr>
                <td colSpan={6} className="py-10 text-center">
                  <Loader2 className="animate-spin inline-block text-blue-600 mr-2" />
                ...
                >
                  ...
                  <td className="py-3 px-4 text-center">
                    <button
                      ...
                      className="flex items-center gap-1 mx-auto bg-blue-100 hover:bg-blue-200 text-blue-800 px-3 py-1.5 rounded-md text-xs transition-all"
                    >
                      <Eye size={14} /> Lihat
                    </button>
                  </td>
