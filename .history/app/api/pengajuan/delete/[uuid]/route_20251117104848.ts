...
            },
            // --- PERUBAHAN UTAMA: Tambahkan BODY JSON ke External API ---
            // Karena API Eksternal Anda mengeluh ID tidak ditemukan, 
            // kita asumsikan API tersebut mencari ID di body JSON.
