...
// type NotificationType dihilangkan
...
export default function EditPengajuanForm({ params }: { params: { uuid: string } }) {
    ...
    // STATE NOTIFICATION DIHILANGKAN
    ...
    const handleSubmissionSuccess = () => {
        // HANYA MELAKUKAN REDIRECT, TIDAK ADA NOTIFIKASI DI SINI
    ...
    return (
        <div className="max-w-4xl mx-auto mt-8">
            <FormLampiranBase
                ...
                // Prop setNotification dihilangkan
                onSubmissionSuccess={handleSubmissionSuccess}
            />
            {/* Panggilan komponen Notification dihilangkan */}
        </div>
    );
}