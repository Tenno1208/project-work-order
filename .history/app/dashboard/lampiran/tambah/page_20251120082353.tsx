...
// GANTI BLOK INI (W-1/2 KOLOM KIRI)

                    <div className="mt-4 flex gap-20">
                        {/* KOLOM KIRI: HAL & REF. SURAT (Dipecah menjadi dua baris, masing-masing menggunakan flex) */}
                        <div className="w-1/2 text-sm">
                            
                            {/* Baris 1: Hal (Label dan Dropdown di samping) */}
...
                                        // Menggunakan flex-grow agar mengisi sisa ruang
                                        className="flex-grow p-1 border border-gray-300 rounded bg-white text-sm select-input-only"
                                    >
...
                            {/* Baris 2: Ref. Surat (Label dan Dropdown di samping) */}
                            <div className="mt-3 flex items-center gap-2 text-xs font-semibold"> 
                                Ref. Surat:
                                {isPrintMode ? (
                                    <span className="font-normal text-xs">{form.referensiSurat || "-"}</span> 
                                ) : (
                                    <div className="select-input-only flex-grow">
                                        <Select
                                            name="referensiSurat"
...
                                            isClearable
                                            styles={{
                                                // Sesuaikan tinggi untuk tampilan kecil
                                                control: (base) => ({ ...base, minHeight: 28, height: 28, fontSize: '0.75rem', border: '1px solid #d1d5db', borderRadius: '0.25rem', background: 'white' }),
...
                                    </div>
                                )}
                                <div className="text-xs text-gray-500 italic mt-1 absolute bottom-[-20px] left-0"> 
                                    *Opsional, diisi jika ada referensi surat sebelumnya.
                                </div>
                            </div>
                        </div>
