...
                                            {/* TEKS YANG DIUBAH */}
                                            <p className="text-gray-700 font-semibold text-lg">Anda belum memiliki riwayat pengajuan.</p>
                                            <p className="text-sm text-gray-500 mt-1">Silakan buat pengajuan baru menggunakan tombol di atas.</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : (
