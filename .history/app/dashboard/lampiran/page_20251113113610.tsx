...
type NavigationLog = {
    message: string;
    type: 'info' | 'delete'; // Menambahkan tipe untuk perbedaan visual
};
...
export default function App() {
    ...
    const handleBuatPengajuan = () => {
        ...
        setTimeout(() => {
            setCreating(false);
            // Menghilangkan log navigasi/redirect sesuai permintaan pengguna.
            // Di sini seharusnya terjadi redirect ke '/dashboard/lampiran/tambah'
        }, 500);
    };

    const handleView = (id: number) => {
        // Menggunakan tipe 'info'
    ...
    const handleConfirmDelete = () => {
        if (itemToDelete) {
            ...
            // Menggunakan tipe 'delete' agar notifikasi berwarna merah
    ...
    return (
        <div className="p-4 md:p-8 space-y-6 text-gray-800 bg-gray-50 min-h-screen font-sans">
            ...
            {/* Global Notification/Navigation Log (Dipertahankan untuk aksi Edit dan Delete) */}
            {navigationLog && (
                <div className={`fixed top-4 right-4 z-50 px-4 py-3 rounded-xl shadow-lg transition-all duration-300 transform slide-in-from-right ${
                    // Memilih styling berdasarkan tipe log
