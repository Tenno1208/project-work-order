...
  };
  
  // Handler untuk upload tanda tangan
...
            max-height: 80px;
            object-fit: contain;
            /* Mengatur posisi agar berada di atas nama */
            margin-bottom: -35px; 
            z-index: 10;
            opacity: 0.9; 
             mix-blend-mode: multiply; /* Mencoba efek 'transparan' untuk latar putih */
          }
        }
...
        </div>
        
        {/* Tombol Upload Tanda Tangan (di luar area cetak) */}
        {!isPrintMode && (
