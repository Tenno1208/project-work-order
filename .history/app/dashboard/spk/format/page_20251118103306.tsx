...
export default function SPKPage() {
  ...
  // 🔹 FETCH DATA SEMUA PEGAWAI DARI API EKSTERNAL
  useEffect(() => {
    const fetchAllPegawai = async () => {
      ...
      try {
        ...
        const apiUrl = "https://gateway.pdamkotasmg.co.id/api-gw/portal-pegawai/api/client/user/all-pegawai";
        
        // Catatan: Header Authorization Bearer harus disertakan untuk akses API eksternal
        ...
        if (Array.isArray(dataArray)) {
          ...
          const names = dataArray.map(item => item.nama_pegawai || item.nama || 'Nama Pegawai Tidak Diketahui');
          setPegawaiList(names.filter(name => name !== 'Nama Pegawai Tidak Diketahui' && name.trim() !== ''));
        } else {
              ...
              <div className="flex items-start mt-2">
                ...
                <div className="flex-1 flex flex-col gap-1">
                  ...
                  <div className="flex flex-wrap items-center p-1 border border-gray-500 rounded-md bg-white min-h-[40px] focus-within:ring-2 focus-within:ring-blue-300">
                    ...
                    {/* Datalist menggunakan data dari API (pegawaiList) */}
