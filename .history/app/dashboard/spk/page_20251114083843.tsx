...
export default function DaftarSPKPage() {
  ...
  const handleView = (spk: SPKItem) => {
    router.push(`/dashboard/spk/format?view=${spk.id}`);
  };

  const handleEdit = (spk: SPKItem) => {
    router.push(`/dashboard/spk/format?edit=${spk.id}`);
  };
                      ...
                      <td className="px-4 py-3 text-center">
                        <div className="flex justify-center gap-2">
                          ...
                          <button
                            ...
                            className="p-2 bg-blue-100 text-blue-700 hover:bg-blue-200 rounded-lg shadow-md hover:scale-105"
                            title="Lihat Detail"
                          >
                            <Eye size={16} />
                          </button>
                          ...
                          <button
                            ...
                            className="p-2 bg-yellow-100 text-yellow-700 hover:bg-yellow-200 rounded-lg shadow-md hover:scale-105"
                            title="Edit SPK"
                          >
                            <Pencil size={16} />
                          </button>
                          ...
                          <button
                            ...
                            className="p-2 bg-red-100 text-red-700 hover:bg-red-200 rounded-lg shadow-md hover:scale-105"
                            title="Hapus SPK"
                          >
                            <Trash2 size={16} />
                          </button>
