          ...
          <div className="flex gap-3">
            <div className="relative">
              ...
              <select
                ...
                className="pl-10 pr-8 py-3 border border-black-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white appearance-none cursor-pointer"
              >
