      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            className="absolute top-1/2 right-3 -translate-y-1/2 bg-white/20 hover:bg-white/30 text-white rounded-full shadow-lg w-8 h-8 flex items-center justify-center transition-all duration-300 border border-white/30 backdrop-blur-md"
          >
