...
const API_BASE_URL = process.env.API_BASE_URL; // Harus diatur ke https://early-apes-rescue.loca.lt
...
export async function DELETE(
    ...
    // Membangun URL DELETE eksternal dengan UUID (perhatikan tidak ada '/' di antara 'delete' dan 'uuid')
