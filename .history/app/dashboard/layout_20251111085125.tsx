      ...
      <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
        ...
        <motion.div
          ...
          <motion.div
            ...
            className="px-6 py-9 border-b border-blue-100/60 bg-gradient-to-br from-blue-00 via-blue-600 to-blue-600 shadow-inner relative"
          >
  ...
  <motion.button
    ...
    className="absolute top-10 -right-4 z-[9999] bg-gradient-to-br from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-full shadow-2xl w-9 h-9 flex items-center justify-center transition-all duration-300 border-4 border-white"
  >
    {collapsed ? <ChevronRight size={20} /> : <ChevronLeft size={20} />}
  </motion.button>
</motion.div>  {/* ✅ tutup motion.div sidebar di sini */}
