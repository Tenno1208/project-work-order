...
// #######################################################################
// PERBAIKAN 1: PERBARUI TIPE DATA ApiPengajuanItem
// Kita menggunakan field 'name_pelapor' dan 'npp_pelapor' yang benar dari API
// #######################################################################
type ApiPengajuanItem = {
    id: number;
    uuid: string; 
    no_surat: string; // Tambahkan no_surat
    hal_id: number;
    catatan: string;
    kepada: string;
    satker: string;
    ...
    file: string | null;
    status: string;
    // Ganti 'name' dan 'npp' dengan yang ada di API
    ...
    created_at: string; 
    updated_at: string;
    // Tambahkan field pelengkap jika ada
...
type Pengajuan = {
    ...
    tanggal: string;
    hal: string; 
    name_pelapor: string; // Akan diisi dengan nama/NPP yang sudah benar
    status: string;
};
        ...
        for (let i = 0; i < MAX_RETRIES; i++) {
            try {
                ...
                const mappedData: Pengajuan[] = activeData.map(item => ({
                    ...
                    // #######################################################################
                    // PERBAIKAN 2: GUNAKAN name_pelapor dan npp_pelapor YANG BENAR
                    // #######################################################################
