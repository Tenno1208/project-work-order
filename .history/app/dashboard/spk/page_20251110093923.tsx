  ...
  <div className="flex flex-col gap-3 flex-1">
    {[1, 2, 3].map((i) => (
      <div key={i} className="flex items-center">
        <div className="w-[25px] text-right pr-2">{i}.</div>
        <select
          value={data[`menugaskan${i}` as keyof typeof data]}
          onChange={(e) => updateField(`menugaskan${i}`, e.target.value)}
          className="border-b border-black outline-none bg-white text-sm py-0.5 px-1 w-full"
                ...
                >
                  ...
                  <div className="flex mt-3 items-center">
                    ...
                    <div
                      ...
                      className="border border-gray-400 rounded-md bg-white outline-none px-2 py-1 text-sm w-[160px] cursor-pointer hover:ring hover:ring-blue-200"
                    >
                      {data.tanggalSelesai}
                    </div>
                  </div>
