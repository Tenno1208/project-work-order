      ...
      <div className="bg-gradient-to-r from-blue-50 to-white rounded-3xl p-8 border border-blue-100 shadow-lg">
        ...
        <div className="relative max-w-md">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 rounded-xl border border-blue-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-300 bg-white shadow-sm text-black"
          />
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl shadow-xl border border-blue-100 overflow-hidden">
        ...
        {filteredData.length === 0 && (
          <div className="px-8 py-12 text-center">
            <History className="mx-auto text-black mb-4" size={48} />
      ...
      <div className="bg-gradient-to-r from-blue-50 to-white rounded-2xl p-6 border border-blue-100">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <p className="text-sm text-black">Terakhir diperbarui:</p>
