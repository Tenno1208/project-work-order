            ...
            <div>
              ...
              {!isPrintMode && (
                <div className="mt-3 text-center">
                  ...
                  {ttdPelaporPreview && (
                    <div className="border border-gray-300 rounded inline-block relative w-[250px] h-[150px] bg-gray-50">
                      <Draggable bounds="parent" nodeRef={nodeRef}>
  <img
    ref={nodeRef} // ✅ Tambahkan ini
    ...
    className="cursor-move absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-h-[120px] max-w-[200px] object-contain"
  />
</Draggable>
