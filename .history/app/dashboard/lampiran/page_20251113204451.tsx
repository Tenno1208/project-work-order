...
// Variabel ini HARUS diawali NEXT_PUBLIC_ agar dapat diakses oleh browser
...
        setTimeout(() => {
            setCreating(false);
            router.push("/dashboard/lampiran/tambah/page.tsx"); // Path ke Tambah Pengajuan
        }, 500);
    };
...
        // FIX: Gunakan .replace untuk mengganti placeholder {id} dengan idToDelete
